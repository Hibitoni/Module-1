...

{
    ...
    if (Number.isNaN(newCount) === 'true') {     //Я понимаю что это может быть не совсем верным сравнением, но  Метод parseint, как я понял, всегда возвращает тип данных Number
